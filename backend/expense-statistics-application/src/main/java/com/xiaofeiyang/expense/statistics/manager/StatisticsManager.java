package com.xiaofeiyang.expense.statistics.manager;
...
import com.xiaofeiyang.expense.statistics.service.StatisticsService;
...
public class StatisticsManager {
    ...
    public TrendVO getMonthlyTrend(Long userId, int months) {
        ...
        List<BillDTO> bills = statisticsService.queryByDateRange(userId, start, end);
    ...
    public DailyVO getDailyDistribution(Long userId, int year, int month) {
        List<BillDTO> bills = statisticsService.queryByMonth(userId, year, month);
